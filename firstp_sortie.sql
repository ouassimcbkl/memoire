...
CREATE TABLE `sortie` (
  ...
  KEY `idemp_idx` (`idemp`),
  CONSTRAINT `idempp` FOREIGN KEY (`idemp`) REFERENCES `employer` (`id`)
...
INSERT INTO `sortie` VALUES (1,47,'2023-05-13 00:00:00','12:43:41','true'),(2,47,'2023-05-14 00:00:00','13:14:19','true');
...
-- Dump completed on 2023-06-01 18:53:27
